        ...
        <Card bg="#564f70" shadow="md" radius="lg" padding="lg">
            <Card.Section>
                <Paper
                    ...
                    className="h-80 flex flex-col justify-between items-start bg-cover bg-center">
                    ...
                    <Flex justify="space-between"
                           ...
                           wrap="nowrap"
                           mt="auto">
                        <Text className="text-[var(--mantine-color-white)] font-bold uppercase drop-shadow-md" size="md">
                            {location}
                        </Text>
            ...
            <Title order={3} className="pt-[var(--mantine-spacing-lg)] text-[color: var(--mantine-color-white)]">
                {name}
            </Title>
            <Text className="text-[var(--mantine-color-white)] font-bold uppercase" size="xs">
                {desc}
            </Text>
        </Card>
    )
...
function OpportunityCard({name, desc, link}: OpportunityCardProps) {
    return (
        <Card bg="#262235" shadow="md" radius="lg" padding="lg">
            <h2 className="m-0 text-[var(--mantine-color-white)]">{name}</h2>
            <Text>{desc}</Text>
...
function ReleasesCard({title, artist, image, link}: ReleasesCardProps) {
    return (
        <Card bg="#262235" shadow="md" radius="lg" padding="lg">
            ...
            <Flex align="flex-start" direction="column" className="pb-4">
